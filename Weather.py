...
def getWeather():
    try :
        ...
        #Weather
        #api = "https://api.openweathermap.org/data/2.5/weather?="+city+"&appid=cca5eb61a8b9ecd7ee6fede930a681b5"
        api = "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=cca5eb61a8b9ecd7ee6fede930a681b5"
